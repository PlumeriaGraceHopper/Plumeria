...
async function seed() {
  ...
  const flowers = await Promise.all([
    ...
    Flower.create({name: 'Lily', price: 1599 , description: 'Integer rutrum nisl aliquet porttitor sodales. Nulla facilisi. Ut convallis ex non eleifend aliquam. Sed commodo fermentum mauris et rhoncus. ', image: "https://h2.commercev3.net/cdn.springhillnursery.com/images/400/64379A.jpg" , color: 'red' , quantity: 20}),
    Flower.create({name: 'Wysteria', price: 2099 , description: 'Duis bibendum lobortis tristique. Ut egestas, sem posuere fringilla tristique, erat elit egestas diam, at placerat eros sem vel enim.', image: "https://h2.commercev3.net/cdn.springhillnursery.com/images/400/75948A.jpg" , color: 'purple' , quantity: 8}),
    Flower.create({name: 'Hydrangea', price: 1299 , description: 'Etiam varius rhoncus risus eget tempor. Pellentesque blandit mauris id velit mattis, vitae aliquam erat rutrum.', image: "https://h2.commercev3.net/cdn.springhillnursery.com/images/400/65694A.jpg", color: 'multi' , quantity: 18}),
    Flower.create({name: 'Lily of the Valley', price: 699 , description: 'Etiam at odio vitae nisi condimentum suscipit id sit amet est. Curabitur id cursus risus. Integer pharetra sem vitae condimentum ultricies.', image: "https://h2.commercev3.net/cdn.springhillnursery.com/images/400/07799A.jpg", color: 'white' , quantity: 18}),
    Flower.create({name: 'Meyer Lemon Tree', price: 1499 , description: 'Suspendisse blandit magna leo, rhoncus porta quam rutrum fermentum. Duis id dictum leo, id fermentum est. Sed ut odio nec magna euismod venenatis facilisis at massa.', image: "https://h2.commercev3.net/cdn.springhillnursery.com/images/400/62752A.jpg", color: 'yellow' , quantity: 18}),
    Flower.create({name: 'Tulip', price: 999 , description: 'Aliquam ante odio, gravida pellentesque ultrices quis, facilisis non velit. Sed lorem arcu, condimentum ut diam dictum, blandit facilisis dui. Nunc vitae nulla non mauris egestas pretium.', image: "https://h2.commercev3.net/cdn.springhillnursery.com/images/400/72599.jpg", color: 'multi' , quantity: 18}),
    Flower.create({name: 'Peony', price: 1199 , description: 'Cras id leo rutrum, porta arcu sit amet, lobortis dui. Donec pharetra consectetur libero, in rutrum metus mattis non. Sed ut odio nec magna euismod venenatis facilisis at massa.', image: "https://h2.commercev3.net/cdn.springhillnursery.com/images/400/02691A.jpg", color: 'white' , quantity: 18}),
    Flower.create({name: 'Rose', price: 1499 , description: 'Nullam commodo, justo at sollicitudin rhoncus, urna quam rutrum ex, vitae facilisis nulla mauris vitae velit. ', image: "https://h2.commercev3.net/cdn.springhillnursery.com/images/400/75391A.jpg", color: 'orange' , quantity: 18}),
  ])
